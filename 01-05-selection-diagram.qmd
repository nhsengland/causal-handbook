...
<figure style="text-align: center;">
  <a href="images/01-05-jw-causal-methods-diagram.svg" target="_blank">
    <img src="images/01-05-jw-causal-methods-diagram.svg">
  </a>
  <figcaption>
    Causal Methods Decision Tree Diagram<br>
    (Clicking on the image will enlarge it in a new tab)
  </figcaption>
</figure>
:::

::: {.content-visible when-format="pdf"}
![](images/01-05-jw-causal-methods-diagram.png)
:::